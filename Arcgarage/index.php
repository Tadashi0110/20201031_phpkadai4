...
if($status==false) {
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    $view .= '<p class="pruducts-thumb"><img src="./img/'.$result["fname"].'" width="200" heiht="200"></p>';
...
<body>
  <header class="header">
    <h1 class="site-title"><a href="#"><img src="images/common/art.png" alt="" width="250px"></a></h1>
  ...
  <div>
    <ul class="bxslider">
      <li><img src="images/index/IMG.jpg" alt=""  ></li>
  ...
  <!-- <div class="outer"> -->
    ...
    <div class="wrapper wrapper-main flex-parent">
      ...
      <main class="wrapper-main">
        <!--並び替えボタン-->
        <div class="sort-area">
          <a href="#" class="sort-text">★★★ログイン／アカウント作成はフッターにあるよ★★★<br>アイテム登録はフッターの『Art Academy』から</a>
  ...
  <footer class="footer">
    <div class="wrapper wrapper-footer">
      ...
      <div class="footer-widget__long">
        <p><a href="cms/item_add.php"><img src="images/common/art.png" alt="" width="200px"></a></p>
      </div>
      ...
      <div class="footer-widget">
        <ul class="nav-footer">
          ...
          <li class="nav-footer__item"><a href="crat.php">Cart</a></li>
    ...
    <p class="copyrights"><small>Copyrights Art Academy Tokyo All Rights Reserved.</small></p>
  </footer>
  <!--end footer-->
